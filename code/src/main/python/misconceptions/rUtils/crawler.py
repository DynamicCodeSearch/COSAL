...
def convert_R_notebooks(force=False):
  irnb_files = cache.list_files(R_NOTEBOOKS_HOME, extension=".irnb", check_nest=True, is_absolute=True)
...
def get_converted_files():
  return cache.list_files(R_NOTEBOOKS_HOME, extension=".R", check_nest=True, is_absolute=True)
