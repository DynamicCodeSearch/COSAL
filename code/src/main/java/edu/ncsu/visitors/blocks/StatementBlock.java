...
public class StatementBlock {
     ...
     */
    public StatementBlock(String fileSource, String parentClass, String methodName, Node statementAST, StatementBlock parentStatement) {
        this.fileSource = fileSource;
        this.parentClass = parentClass;
        this.methodName = methodName;
        this.statementAST = statementAST;
        if (this.statementAST.getBegin().isPresent()) {
            this.startLine = this.statementAST.getBegin().get().line;
            this.startColumn = this.statementAST.getBegin().get().column;
        }
        if (this.statementAST.getEnd().isPresent()) {
            this.endLine = this.statementAST.getEnd().get().line;
            this.endColumn = this.statementAST.getEnd().get().column;
        }
