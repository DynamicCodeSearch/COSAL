...
public class ConstantAdapter extends VoidVisitorAdapter{
    ...
    public ConstantAdapter(String javaFilePath) {
        ...
        this.compilationUnitParseResult = VisitorHelper.parseFile(this.javaFilePath);
        constantsMap = new HashMap<>();
        visit(VisitorHelper.loadCompilationUnit(compilationUnitParseResult), new Object());
    }
