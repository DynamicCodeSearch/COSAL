...
public class DeadCode {
    ...
    private static void transfer(String sourceFile, String targetFile) {
        CompilationUnit source = VisitorHelper.loadCompilationUnit(VisitorHelper.parseFile(sourceFile));
        CompilationUnit target = VisitorHelper.loadCompilationUnit(VisitorHelper.parseFile(targetFile));
